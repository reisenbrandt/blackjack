...
def results(player_hand, dealer_hand, start):
    ...
    if score_hand(dealer_hand) >= 17:
        ...
        # totals are the same -automatic tie
            ...
            print('It\'s a tie!')
            print(f'You don\'t gain or lose any money. You have ${start}.')
...
while play[0] == 'y':
    ...
    if player_bust == False:
        ...
        start = results(player_hand, dealer_hand, start)
        # print(start)
